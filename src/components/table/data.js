export const data = {
  ...
  harmony_before: {
    title: "Alcohol & fast-food<b> before Blueprint</b>",
    content:
      "<li className='li-style'>Reduce my attendance to events where it's primarily around drinking and parties</li><li className='li-style'>Reducing my fast-food intake</li></ul><h4>Friction Points:</h4><p>I often found it difficult to say no to alcohol at social events. It was such a large part of my early social life that I've found it difficult to decouple it from social events in the evening.</p><p>Food has often been a solution to feeling 'busy.' Consuming foods with large amounts of carbohydrate and fat, for me (and I'm sure for many others), acts as self-medication for anxiety. (Fun fact: it is this point alone that seems to me to be the initial problem that generated the Blueprint protocol from Bryan Johnson.)</p>",
  },
  harmony_after: {
    title: "Zero* Alcohol. <u>Zero</u> fast-food<b> after Blueprint</b>",
    content:
      "<li className='li-style'>Zero alcohol when I'm meeting people in groups greater than or equal to 3</li><li className='li-style'>Zero fast-food.</li></ul><h4>Solving for:</h4><p>Using alcohol as a crutch for experiencing normal social behaviors: I find it quite easy to meet one-on-one with just about anybody. It's in groups where I seem to want to lean into alcohol to make the experience more manageable. I've identified that when I do drink, I often come away from the social event lacking the meaningfulness that I otherwise do when I'm not drinking. As for why I'm less reluctant to have a drink when it's just two people; well, I'd eventually like to move to having zero alcohol, but for now, I appreciate that for people who enjoy wine, having a glass when the person opposite is having water sometimes lessens their ~vibe~.</p><p>Eating any fast-food: Across a time window greater than 24 hours, I never enjoy fast-food. The main thing I'm solving for here is eating fast-food alone (Uber Eats, drive-through burgers, etc.). For myself, I'm a hard no. When the only food being offered is fast-food at a social event, I'll opt for either managing my hunger or duck out for a quick, healthier snack.</p>",
  },
  self_before: {
    title: "1, 3 and 10 year goals, <b> before Blueprint</b>",
    content:
      "<li className='li-style'>Organizing goals by their estimated time to completion, categorized under timeframes of 1, 3, and 10 years, may facilitate effective planning and prioritization.</li></ul><h4>Friction points</h4><p>Listing goals explicitly aids in defining them more clearly. However, the method also poses the issue of perceived dilution of focus across multiple objectives. The strategy employed typically involves a weekly review of these goals, followed by daily task allocation aimed at advancing each one. Historically my data suggests that approximately 2 out of an average of 10 enumerated goals are achieved.</p>",
  },
  self_after: {
  ...
  norms_after: {
    title:
      "A blanket turning away from events that invoke poor behaviors in me,<b> after Blueprint</b>",
    content:
